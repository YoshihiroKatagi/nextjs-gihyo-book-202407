  ...
  return (
    <>
      <Head>
        ...
        <meta name="og:title" content={SITE_TITLE} key="meta:og:title" />
        <meta name="og:description" content={SITE_DESCRIPTION} key="meta:og:description" />
        <meta name="og:image" content={`${publicRuntimeConfig.domainUrl|/static/images/icon/icon-512.png`} key="meta:og:image" />
